...
genres              ->      AlbumController()->list();          -Lista todos los albumes
genres/id           ->      AlbumController()->list($id);       -Lista el detalle de un album
genres-save         ->      AlbumController()->save();          -Guarda un nuevo album desde el form de alta
genres-edit/id      ->      AlbumController()->edit($id);       -Carga el form de edicion
genres-save/id      ->      AlbumController()->save($id);       -Guarda modificaciones a un album desde el form de edicion
genres-remove/id    ->      AlbumController()->remove($id);     -Elimina un album si no tiene dependencias, de tenerlas da la eleccion al usuario
genres-rmvall/id    ->      AlbumController()->rmvall($id);     -Elimina un album y todas sus dependencias 
